...
class ShopifyController(http.Controller):
    ...
    def shopify_app_entry(self, account_id, **data):
        ...
        calculated_hmac = hmac.new(
            account.shopify_client_secret.encode('utf-8'),
    ...
    def handle_shopify_oauth_callback(self, account_id, **data):
        ...
        try:
            ...
            _logger.error('Exception occuer during generate access token from oauth code: %s in shopify, error_description: %s', data.get('code'), e)
